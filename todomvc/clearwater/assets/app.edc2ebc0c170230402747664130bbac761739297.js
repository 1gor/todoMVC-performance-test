...
});Opal.loaded(["clearwater/virtual_dom/js/virtual_dom"]);
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/virtual_dom"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$camelized_native', '$sanitize_content', '$map!', '$create_element', '$document', '$rendered?', '$diff', '$patch', '$inner_dom=', '$to_n', '$keys', '$[]', '$camelize']);
  self.$require("clearwater/virtual_dom/js/virtual_dom.js");
  return (function($base) {
    var $VirtualDOM, self = $VirtualDOM = $module($base, 'VirtualDOM');

    var def = self.$$proto, $scope = self.$$scope;

    Opal.defs(self, '$node', function(tag_name, attributes, content) {
      var self = this;
      ...
      return virtualDom.h(
        tag_name,
        $scope.get('HashUtils').$camelized_native(attributes),
        self.$sanitize_content(content)
      );
    ;
    });

    Opal.defs(self, '$svg', function(tag_name, attributes, content) {
      var self = this;
    ...
    Opal.defs(self, '$create_element', function(node) {
      var self = this;

      return virtualDom.create(node);
    });

    Opal.defs(self, '$diff', function(first, second) {
      var self = this;

      return virtualDom.diff(first, second);
    });

    Opal.defs(self, '$patch', function(node, diff) {
      var self = this;

      return virtualDom.patch(node, diff);
    });

    Opal.defs(self, '$sanitize_content', function(content) {
      var $a, $b, TMP_1, self = this;

      
      if(content === Opal.nil || content === undefined) return null;
      if(content.$$is_array)
        return ($a = ($b = content)['$map!'], $a.$$p = (TMP_1 = function(c){var self = TMP_1.$$s || this;
if (c == null) c = nil;
      return self.$sanitize_content(c)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      return content;
    ...
    (function($base, $super) {
      ...
      def.node = def.tree = def.root = def.rendered = nil;
      Opal.defn(self, '$initialize', function(root) {
        var self = this;

        if (root == null) {
          root = $scope.get('Bowser').$document().$create_element("div")
        }
        return self.root = root;
      });

      Opal.defn(self, '$render', function(node) {
        var $a, $b, self = this, diff = nil;

        if ((($a = self['$rendered?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          diff = $scope.get('VirtualDOM').$diff(self.node, node);
          $scope.get('VirtualDOM').$patch(self.tree, diff);
          return self.node = node;
          } else {
          self.node = node;
          self.tree = self.$create_element(node);
          (($a = [self.tree]), $b = self.root, $b['$inner_dom='].apply($b, $a), $a[$a.length-1]);
          return self.rendered = true;
        };
      });

      Opal.defn(self, '$create_element', function(node) {
        var self = this;

        return virtualDom.create(node);
      });

      return (Opal.defn(self, '$rendered?', function() {
        var self = this;
    ...
    (function($base) {
      var $StringUtils, self = $StringUtils = $module($base, 'StringUtils');

      var def = self.$$proto, $scope = self.$$scope;

      Opal.defs(self, '$camelize', function(string) {
        var self = this;

        return string.replace(/_(\w)/g, self.$_camelize_handler);
      });

      Opal.defs(self, '$_camelize_handler', function(_, character_match) {
        var self = this;
    ...
    (function($base) {
      var $HashUtils, self = $HashUtils = $module($base, 'HashUtils');

      var def = self.$$proto, $scope = self.$$scope;

      Opal.defs(self, '$camelized_native', function(hash) {
        var $a, self = this;

        if ((($a = !!hash.$$is_hash) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          return hash.$to_n()
        };
        ...
        for(var index = 0; index < keys.length; index++) {
          key = keys[index];
          v = hash['$[]'](key);
          js_obj[$scope.get('StringUtils').$camelize(key)] = v.$$is_hash ? self.$camelized_native(v) : v
        }
        return js_obj;
      ;
      })
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/component/html_tags"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/component"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$params', '$router', '$is_a?', '$each', '$==', '$[]=', '$proc', '$call', '$new', '$key?', '$warn', '$+', '$delete', '$map', '$sanitize_content', '$module_function', '$define_method', '$tag', '$node', '$sanitize_attributes', '$render_all', '$to_proc']);
  self.$require("clearwater/virtual_dom");
  self.$require("clearwater/component/html_tags");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base) {
      ...
      self.$attr_accessor("router", "outlet");
      ...
      Opal.defs(self, '$sanitize_attributes', function(attributes) {
        var $a, $b, TMP_1, self = this;

        if ((($a = attributes['$is_a?']($scope.get('Hash'))) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          return attributes
        };
        ($a = ($b = attributes).$each, $a.$$p = (TMP_1 = function(key, value){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (key == null) key = nil;if (value == null) value = nil;
        if ((key.slice(0, 2))['$==']("on")) {
            return attributes['$[]='](key, ($a = ($b = self).$proc, $a.$$p = (TMP_2 = function(event){var self = TMP_2.$$s || this;
if (event == null) event = nil;
            return value.$call((($scope.get('Bowser')).$$scope.get('Event')).$new(event))}, TMP_2.$$s = self, TMP_2), $a).call($b))
            } else {
            return nil
          }}, TMP_1.$$s = self, TMP_1), $a).call($b);
        if ((($a = attributes['$key?']("class")) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = attributes['$key?']("class_name")) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.$warn($rb_plus("You have both `class` and `class_name` attributes for this ", "element. `class` takes precedence: " + (attributes)))};
      ...
      Opal.defs(self, '$sanitize_content', function(content) {
        ...
        if(content && content.$$class) {
          if(content.$$is_array) {
            return ($a = ($b = content).$map, $a.$$p = (TMP_3 = function(c){var self = TMP_3.$$s || this;
if (c == null) c = nil;
        return self.$sanitize_content(c)}, TMP_3.$$s = self, TMP_3), $a).call($b);
          } else {
      ...
      ($a = ($b = $scope.get('HTML_TAGS')).$each, $a.$$p = (TMP_4 = function(tag_name){var self = TMP_4.$$s || this, $a, $b, TMP_5;
if (tag_name == null) tag_name = nil;
      return ($a = ($b = self).$define_method, $a.$$p = (TMP_5 = function(attributes, content){var self = TMP_5.$$s || this;
if (attributes == null) attributes = nil;if (content == null) content = nil;
          ...
          return self.$tag(tag_name, attributes, content);}, TMP_5.$$s = self, TMP_5), $a).call($b, tag_name)}, TMP_4.$$s = self, TMP_4), $a).call($b);

      Opal.defn(self, '$tag', function(tag_name, attributes, content) {
        var self = this;
        ...
        return $scope.get('VirtualDOM').$node(tag_name, $scope.get('Component').$sanitize_attributes(attributes), $scope.get('Component').$sanitize_content(content));
      });

      Opal.defn(self, '$call', TMP_6 = function() {
        var $a, $b, self = this, $iter = TMP_6.$$p, block = $iter || nil;

        TMP_6.$$p = null;
        return ($a = ($b = (((($scope.get('Clearwater')).$$scope.get('Application'))).$$scope.get('AppRegistry'))).$render_all, $a.$$p = block.$to_proc(), $a).call($b);
      });
    })($scope.base)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/svg_component"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$each_with_object', '$[]', '$[]=', '$==', '$proc', '$call', '$new', '$module_function', '$each', '$define_method', '$tag', '$!', '$svg', '$sanitize_attributes', '$sanitize_content']);
  self.$require("clearwater/component");
  self.$require("clearwater/virtual_dom");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base) {
      var $SVGComponent, self = $SVGComponent = $module($base, 'SVGComponent');
...
if (event == null) event = nil;
      ...
      ($a = ($b = $scope.get('SVG_TAGS')).$each, $a.$$p = (TMP_3 = function(method_name, tag_name){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (method_name == null) method_name = nil;if (tag_name == null) tag_name = nil;
      return ($a = ($b = self).$define_method, $a.$$p = (TMP_4 = function(attributes, content){var self = TMP_4.$$s || this;
if (attributes == null) attributes = nil;if (content == null) content = nil;
        return self.$tag(tag_name, attributes, content)}, TMP_4.$$s = self, TMP_4), $a).call($b, method_name)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      ...
      Opal.defn(self, '$tag', function(tag_name, attributes, content) {
        ...
        if ((($a = ((attributes.$$is_hash || attributes === nil))['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          content = attributes;
          attributes = nil;};
        return $scope.get('VirtualDOM').$svg(tag_name, $scope.get('SVGComponent').$sanitize_attributes(attributes), $scope.get('Component').$sanitize_content(content));
      });
    })($scope.base)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/cached_render"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$require', '$!', '$should_render?', '$sanitize_content', '$render']);
  self.$require("clearwater/component");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base) {
      var $CachedRender, self = $CachedRender = $module($base, 'CachedRender');
      ...
      Opal.defs(self, '$included', function(base) {
        ...
        Opal.defn(self, 'render', function(prev) {
          ...
          if(prev && prev.vnode && self['$should_render?'](prev)['$!']()) {
            return prev.vnode;
          } else {
            return $scope.get('Component').$sanitize_content(self.$render());
          }
        });
      
      });

      Opal.defn(self, '$should_render?', function(_) {
        var self = this;
...
/* Generated by Opal 0.9.2 */
Opal.modules["bowser/event"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$new', '$one?', '$gsub', '$upcase', '$[]']);
  return (function($base) {
    var $Bowser, self = $Bowser = $module($base, 'Bowser');
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$stop_propagation', function() {
        var self = this;
      ...
      Opal.defn(self, '$prevented?', function() {
        ...
        return self["native"].defaultPrevented;
      });
      ...
      Opal.defn(self, '$target', function() {
        ...
        return $scope.get('Element').$new(self["native"].currentTarget);
      });
      ...
      return (Opal.defn(self, '$method_missing', TMP_2 = function() {
        var $a, $b, TMP_1, self = this, $iter = TMP_2.$$p, $yield = $iter || nil, property = nil, $splat_index = nil, $zuper = nil, $zuper_index = nil;
        ...
        if ((($a = args['$one?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          property = ($a = ($b = args['$[]'](0)).$gsub, $a.$$p = (TMP_1 = function(match){var self = TMP_1.$$s || this;
if (match == null) match = nil;
          return match['$[]'](-1, 1).$upcase()}, TMP_1.$$s = self, TMP_1), $a).call($b, /_[a-z]/);
          return self["native"][property];
          } else {
...
/* Generated by Opal 0.9.2 */
Opal.modules["bowser/event_target"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$require', '$proc', '$call', '$new', '$warn']);
  self.$require("bowser/event");
  return (function($base) {
    var $Bowser, self = $Bowser = $module($base, 'Bowser');
    ...
    (function($base) {
      var $EventTarget, self = $EventTarget = $module($base, 'EventTarget');

      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3;

      Opal.defn(self, '$on', TMP_1 = function(event_name) {
        var $a, $b, TMP_2, self = this, $iter = TMP_1.$$p, block = $iter || nil, wrapper = nil;
        if (self["native"] == null) self["native"] = nil;

        TMP_1.$$p = null;
        wrapper = ($a = ($b = self).$proc, $a.$$p = (TMP_2 = function(event){var self = TMP_2.$$s || this;
if (event == null) event = nil;
        return block.$call($scope.get('Event').$new(event))}, TMP_2.$$s = self, TMP_2), $a).call($b);
        if ((($a = self["native"].addEventListener !== undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
          self["native"].addEventListener(event_name, wrapper);
        } else if ((($a = self["native"].addListener !== undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
          self["native"].addListener(event_name, wrapper);
          } else {
          self.$warn("[Bowser] Not entirely sure how to add an event listener to " + (self))
        };
        return wrapper;
      });

      Opal.defn(self, '$off', TMP_3 = function(event_name) {
        var $a, self = this, $iter = TMP_3.$$p, block = $iter || nil;
        if (self["native"] == null) self["native"] = nil;

        TMP_3.$$p = null;
        if ((($a = self["native"].removeEventListener !== undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
          self["native"].removeEventListener(event_name, block);
        } else if ((($a = self["native"].removeListener !== undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
          self["native"].removeListener(event_name, block);
          } else {
          self.$warn("[Bowser] Not entirely sure how to remove an event listener from " + (self))
        };
        return nil;
      });
    })($scope.base)
...
/* Generated by Opal 0.9.2 */
Opal.modules["bowser/file_list"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$include', '$each_with_object', '$[]=', '$new', '$times', '$length', '$[]', '$each', '$call', '$dup', '$to_s', '$attr_reader', '$on', '$result', '$resolve', '$reject', '$read_as_binary_string']);
  self.$require("bowser/event_target");
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $FileList(){};
      var self = $FileList = $klass($base, $super, 'FileList', $FileList);

      var def = self.$$proto, $scope = self.$$scope, TMP_2;

      def.files = def["native"] = nil;
      self.$include($scope.get('Enumerable'));
      ...
      Opal.defn(self, '$initialize', function(native$) {
        ...
        self["native"] = native$ || [];
        return self.files = ($a = ($b = self.$length().$times()).$each_with_object, $a.$$p = (TMP_1 = function(index, array){var self = TMP_1.$$s || this;
          if (self["native"] == null) self["native"] = nil;
if (index == null) index = nil;if (array == null) array = nil;
        return array['$[]='](index, $scope.get('File').$new(self["native"][index]))}, TMP_1.$$s = self, TMP_1), $a).call($b, []);
      });
      ...
      Opal.defn(self, '$each', TMP_2 = function() {
        ...
        TMP_2.$$p = null;
        return ($a = ($b = self.files).$each, $a.$$p = (TMP_3 = function(file){var self = TMP_3.$$s || this;
if (file == null) file = nil;
        return block.$call(file)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      });

      Opal.defn(self, '$to_a', function() {
        var self = this;

        return self.files.$dup();
      });
      ...
      return (function($base, $super) {
        ...
        Opal.defn(self, '$last_modified', function() {
          var self = this;

          return self["native"].lastModifiedDate;
        });

        Opal.defn(self, '$read', function() {
          var $a, $b, TMP_4, $c, TMP_5, self = this, promise = nil, reader = nil;

          promise = $scope.get('Promise').$new();
          reader = $scope.get('FileReader').$new();
          ($a = ($b = reader).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, result = nil;

          result = reader.$result();
            self.data = result;
            return promise.$resolve(result);}, TMP_4.$$s = self, TMP_4), $a).call($b, "load");
          ($a = ($c = reader).$on, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

          return promise.$reject(reader.$result())}, TMP_5.$$s = self, TMP_5), $a).call($c, "error");
        ...
        return (function($base, $super) {
          function $FileReader(){};
          var self = $FileReader = $klass($base, $super, 'FileReader', $FileReader);

          var def = self.$$proto, $scope = self.$$scope;

          def["native"] = nil;
          self.$include($scope.get('EventTarget'));

          Opal.defn(self, '$initialize', function() {
            var self = this;

            return self["native"] = new FileReader();
          });
          ...
          return (Opal.defn(self, '$read_as_binary_string', function(file) {
            var self = this;

            return self["native"].readAsBinaryString(file.native);
          }), nil) && 'read_as_binary_string';
        })($scope.base, null);
      })($scope.base, null);
    })($scope.base, null)
  })($scope.base);
...
/* Generated by Opal 0.9.2 */
Opal.modules["bowser/element"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$include', '$clear', '$append', '$first', '$files', '$new']);
  self.$require("bowser/event_target");
  self.$require("bowser/file_list");
  return (function($base) {
    var $Bowser, self = $Bowser = $module($base, 'Bowser');
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$append', function(node) {
        var self = this;
      ...
      return (Opal.defn(self, '$files', function() {
        var self = this;

        return $scope.get('FileList').$new(self["native"].files);
      }), nil) && 'files';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["bowser/window"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_divide(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs / rhs : lhs['$/'](rhs);
  ...
  Opal.add_stubs(['$require', '$extend', '$module_function', '$delay', '$to_proc', '$/']);
  self.$require("bowser/event_target");
  return (function($base) {
    var $Bowser, self = $Bowser = $module($base, 'Bowser');
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, $a, TMP_1, TMP_2, TMP_3, TMP_4;
      if (self["native"] == null) self["native"] = nil;

      self.$extend($scope.get('EventTarget'));

      self["native"] = window;

      self.$module_function();

      if ((($a = self["native"].requestAnimationFrame !== undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
        Opal.defn(self, '$animation_frame', TMP_1 = function() {
          var self = this, $iter = TMP_1.$$p, block = $iter || nil;
        ...
        Opal.defn(self, '$animation_frame', TMP_2 = function() {
          var $a, $b, self = this, $iter = TMP_2.$$p, block = $iter || nil;

          TMP_2.$$p = null;
          ($a = ($b = self).$delay, $a.$$p = block.$to_proc(), $a).call($b, $rb_divide(1.0, 60));
          return self;
        })
      };
      ...
      Opal.defn(self, '$interval', TMP_4 = function(duration) {
        var self = this, $iter = TMP_4.$$p, block = $iter || nil;
      ...
      Opal.defn(self, '$location', function() {
        ...
        return $scope.get('Location');
      });

      Opal.defn(self, '$scroll', function(x, y) {
        var self = this;
      ...
      (function($base) {
        ...
        Opal.defn(self, '$href', function() {
          var self = this;

          return window.location.href;
        });

        Opal.defn(self, '$href=', function(href) {
          var self = this;
      ...
      (function($base) {
        var $History, self = $History = $module($base, 'History');

        var def = self.$$proto, $scope = self.$$scope;

        self.$module_function();

        Opal.defn(self, '$push', function(path) {
          var self = this;
      ...
      Opal.defn(self, '$history', function() {
        var self = this;
    ...
    Opal.defn(self, '$window', function() {
      ...
      return $scope.get('Window');
    });
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["bowser/document"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$require', '$extend', '$module_function', '$new']);
  self.$require("bowser/event_target");
  self.$require("bowser/element");
  return (function($base) {
    var $Bowser, self = $Bowser = $module($base, 'Bowser');
    ...
    (function($base) {
      var $Document, self = $Document = $module($base, 'Document');
      ...
      Opal.defn(self, '$body', function() {
        ...
        return ((($a = self.body) !== false && $a !== nil) ? $a : self.body = $scope.get('Element').$new(self["native"].body));
      });

      Opal.defn(self, '$[]', function(css) {
        var $a, self = this, native$ = nil;
        if (self["native"] == null) self["native"] = nil;

        native$ = self["native"].querySelector(css);
        if ((($a = native$ === null) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          return $scope.get('Element').$new(native$)
        };
      });

      Opal.defn(self, '$create_element', function(type) {
        var self = this;

        return $scope.get('Element').$new(document.createElement(type));
      });
    })($scope.base);
    ...
    Opal.defn(self, '$document', function() {
      ...
      return $scope.get('Document');
    });
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["bowser"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
  ...
  self.$require("bowser/event");
  self.$require("bowser/event_target");
  self.$require("bowser/window");
  self.$require("bowser/document");
  return (function($base) {
    var $Bowser, self = $Bowser = $module($base, 'Bowser');
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/link"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$include', '$attr_reader', '$delete', '$dup', '$merge', '$method', '$[]', '$check_active', '$call', '$prevented?', '$warn', '$+', '$navigate', '$meta?', '$shift?', '$ctrl?', '$alt?', '$==', '$button', '$prevent', '$window', '$!=', '$href', '$path', '$location', '$navigate_to', '$scroll', '$attributes', '$a', '$content', '$to_s', '$[]=']);
  self.$require("clearwater/component");
  self.$require("bowser");
  return (function($base, $super) {
    function $Link(){};
    ...
    def.onclick = def.attributes = nil;
    self.$include((($scope.get('Clearwater')).$$scope.get('Component')));

    self.$attr_reader("attributes", "content");

    Opal.defn(self, '$initialize', function(attributes, content) {
      var self = this;
      ...
      self.onclick = attributes.$dup().$delete("onclick");
      self.attributes = attributes.$merge($hash2(["onclick", "key"], {"onclick": self.$method("handle_click"), "key": attributes['$[]']("href")}));
      self.$check_active(attributes['$[]']("href"));
      return self.content = content;
    });

    Opal.defn(self, '$handle_click', function(event) {
      var $a, self = this;

      if ((($a = self.onclick) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.onclick.$call(event)};
      if ((($a = event['$prevented?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$navigate', function(event) {
      var $a, $b, $c, $d, self = this, modified = nil, window = nil;

      modified = (((($a = ((($b = ((($c = ((($d = event['$meta?']()) !== false && $d !== nil) ? $d : event['$shift?']())) !== false && $c !== nil) ? $c : event['$ctrl?']())) !== false && $b !== nil) ? $b : event['$alt?']())) !== false && $a !== nil) ? $a : event.$button()['$=='](1)));
      if (modified !== false && modified !== nil) {
        return nil};
      event.$prevent();
      window = $scope.get('Bowser').$window();
      if ((($a = self.$href()['$!='](window.$location().$path())) !== nil && (!$a.$$is_boolean || $a == true))) {
        (($scope.get('Clearwater')).$$scope.get('Router')).$navigate_to(self.$href());
    ...
    Opal.defn(self, '$render', function() {
      ...
      return self.$a(self.$attributes(), self.$content());
    });

    return (Opal.defn(self, '$check_active', function(href) {
      var $a, $b, self = this, class_name = nil;

      if ($scope.get('Bowser').$window().$location().$path()['$=='](href)) {
        class_name = (((($a = ((($b = self.attributes.$delete("class_name")) !== false && $b !== nil) ? $b : self.attributes.$delete("class"))) !== false && $a !== nil) ? $a : self.attributes.$delete("className"))).$to_s();
        return self.attributes['$[]=']("className", "" + (class_name) + " active");
        } else {
        return nil
      };
    }), nil) && 'check_active';
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/router/route"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$fetch', '$warn', '$+', '$key', '$route', '$to_proc', '$nested_routes', '$gsub', '$canonical_path', '$parent', '$==', '$param_key?', '$any?', '$Array', '$[]', '$namespace', '$private', '$start_with?', '$new']);
  self.$require("clearwater/router/route_collection");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        def.target = def.canonical_path = def.param_key = def.nested_routes = nil;
        self.$attr_reader("target", "key", "parent");
        ...
        Opal.defn(self, '$initialize', function(options) {
          ...
          self.target = options.$fetch("target");
          self.parent = options.$fetch("parent");
          if ((($a = self.target.type === 'Thunk' && typeof self.target.render === 'function') !== nil && (!$a.$$is_boolean || $a == true))) {
            return self.$warn($rb_plus($rb_plus("Route '" + (self.$key()) + "' points to a cached component. Cached ", "components must not be persistent components, such as "), "application roots or routing targets."))
            } else {
            return nil
          };
        });
        ...
        Opal.defn(self, '$route', TMP_1 = function() {
          ...
          TMP_1.$$p = null;
          return ($a = ($b = self.$nested_routes()).$route, $a.$$p = block.$to_proc(), $a).apply($b, Opal.to_a(args));
        });

        Opal.defn(self, '$canonical_path', function() {
          var $a, self = this;

          return ((($a = self.canonical_path) !== false && $a !== nil) ? $a : self.canonical_path = (((("") + (self.$parent().$canonical_path())) + "/") + (self.$key())).$gsub("//", "/"));
        });

        Opal.defn(self, '$match', function(key, other_parts) {
          var $a, $b, $c, self = this;

          if (other_parts == null) {
            other_parts = []
          }
          if ((($a = (($b = key !== false && key !== nil) ? (((($c = key['$=='](self.$key())) !== false && $c !== nil) ? $c : self['$param_key?']())) : key)) !== nil && (!$a.$$is_boolean || $a == true))) {
            if ((($a = self.$Array(other_parts)['$any?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return [self, self.$nested_routes()['$[]'](other_parts)]
              } else {
              return self
            }
            } else {
        ...
        Opal.defn(self, '$namespace', function() {
          ...
          return self.$parent().$nested_routes().$namespace();
        });

        self.$private();

        Opal.defn(self, '$param_key?', function() {
          var $a, self = this;

          return ((($a = self.param_key) !== false && $a !== nil) ? $a : self.param_key = self.$key()['$start_with?'](":"));
        });

        return (Opal.defn(self, '$nested_routes', function() {
          var $a, self = this;

          return ((($a = self.nested_routes) !== false && $a !== nil) ? $a : self.nested_routes = $scope.get('RouteCollection').$new(self));
        }), nil) && 'nested_routes';
      })($scope.base, null)
    })($scope.base, null)
  })($scope.base);
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/router/route_collection"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$loop', '$is_a?', '$parent', '$to_s', '$first', '$keys', '$delete', '$router=', '$router', '$merge', '$new', '$instance_exec', '$to_proc', '$<<', '$any?', '$==', '$[]', '$map', '$match', '$compact!', '$flatten!', '$private']);
  self.$require("clearwater/router/route");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        var self = $RouteCollection = $klass($base, $super, 'RouteCollection', $RouteCollection);

        var def = self.$$proto, $scope = self.$$scope, TMP_2;

        def.routes = def.namespace = nil;
        ...
        Opal.defn(self, '$initialize', function(parent) {
          ...
          self.routes = [];
          self.parent = parent;
          return self.router = ($a = ($b = self).$loop, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a;

          if ((($a = parent['$is_a?']($scope.get('Router'))) !== nil && (!$a.$$is_boolean || $a == true))) {
              return ($breaker.$v = parent, $breaker)};
            return parent = parent.$parent();}, TMP_1.$$s = self, TMP_1), $a).call($b);
        });

        Opal.defn(self, '$route', TMP_2 = function(route_options) {
          var $a, $b, self = this, $iter = TMP_2.$$p, block = $iter || nil, route_key = nil, target = nil, options = nil, route = nil;

          TMP_2.$$p = null;
          route_key = route_options.$keys().$first().$to_s();
          target = route_options.$delete(route_key);
          (($a = [self.$router()]), $b = target, $b['$router='].apply($b, $a), $a[$a.length-1]);
          options = $hash2(["key", "target", "parent"], {"key": route_key, "target": target, "parent": self.$parent()}).$merge(route_options);
          route = $scope.get('Route').$new(options);
          if ((block !== nil)) {
            ($a = ($b = route).$instance_exec, $a.$$p = block.$to_proc(), $a).call($b)};
          return self.routes['$<<'](route);
        });

        Opal.defn(self, '$namespace', function() {
          var self = this, path = nil, $splat_index = nil;
        ...
        Opal.defn(self, '$[]', function(route_names) {
          var $a, $b, TMP_3, self = this, routes = nil;

          if ((($a = ($b = route_names['$any?'](), $b !== false && $b !== nil ?route_names.$first()['$=='](self.namespace) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            route_names = route_names['$[]']($range(1, -1, false))};
          routes = ($a = ($b = self.routes).$map, $a.$$p = (TMP_3 = function(r){var self = TMP_3.$$s || this;
if (r == null) r = nil;
          return r.$match(route_names.$first(), route_names['$[]']($range(1, -1, false)))}, TMP_3.$$s = self, TMP_3), $a).call($b);
          routes['$compact!']();
          routes['$flatten!']();
          return routes;
        });
        ...
        return self.$attr_reader("parent");
      })($scope.base, null)
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/router"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$==', '$fetch', '$window', '$location', '$history', '$new', '$[]', '$add_routes', '$to_proc', '$instance_exec', '$get_path_parts', '$join', '$map', '$namespace', '$key', '$routes_for_path', '$canonical_path_for_path', '$reduce', '$start_with?', '$[]=', '$each_with_index', '$current_path', '$path', '$href', '$push', '$set_outlets', '$render_application', '$render_all_apps', '$href=', '$back', '$any?', '$times', '$outlet=', '$+', '$count', '$application', '$first', '$component', '$targets_for_path', '$private', '$reject', '$split', '$call', '$render']);
  self.$require("clearwater/router/route_collection");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base, $super) {
      ...
      def.routes = nil;
      self.$attr_reader("window", "location", "history");

      self.$attr_accessor("application");

      Opal.defn(self, '$initialize', TMP_1 = function(options) {
        var $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, $e, self = this, $iter = TMP_1.$$p, block = $iter || nil;
        ...
        if ($scope.get('RUBY_ENGINE')['$==']("opal")) {
          self.window = ($a = ($b = options).$fetch, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

          return $scope.get('Bowser').$window()}, TMP_2.$$s = self, TMP_2), $a).call($b, "window");
          self.location = ($a = ($c = options).$fetch, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

          return self.$window().$location()}, TMP_3.$$s = self, TMP_3), $a).call($c, "location");
          self.history = ($a = ($d = options).$fetch, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

          return self.$window().$history()}, TMP_4.$$s = self, TMP_4), $a).call($d, "history");};
        self.routes = $scope.get('RouteCollection').$new(self);
        self.application = options['$[]']("application");
        if ((block !== nil)) {
          return ($a = ($e = self).$add_routes, $a.$$p = block.$to_proc(), $a).call($e)
          } else {
          return nil
        };
      });

      Opal.defn(self, '$add_routes', TMP_5 = function() {
        var $a, $b, self = this, $iter = TMP_5.$$p, block = $iter || nil;

        TMP_5.$$p = null;
        return ($a = ($b = self.routes).$instance_exec, $a.$$p = block.$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$routes_for_path', function(path) {
        var self = this, parts = nil;

        parts = self.$get_path_parts(path);
        return self.routes['$[]'](parts);
      });

      Opal.defn(self, '$canonical_path_for_path', function(path) {
        var $a, $b, TMP_6, self = this;

        return ($a = ($b = self.$routes_for_path(path)).$map, $a.$$p = (TMP_6 = function(r){var self = TMP_6.$$s || this, namespace = nil;
if (r == null) r = nil;
        namespace = r.$namespace();
          return "" + ((function() {if (namespace !== false && namespace !== nil) {
            return "/" + (namespace)
            } else {
            return nil
          }; return nil; })()) + "/" + (r.$key());}, TMP_6.$$s = self, TMP_6), $a).call($b).$join();
      });

      Opal.defn(self, '$targets_for_path', function(path) {
        var $a, $b, self = this;

        return ($a = ($b = self.$routes_for_path(path)).$map, $a.$$p = "target".$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$params', function(path) {
        var $a, $b, TMP_7, self = this, path_parts = nil, canonical_parts = nil;

        if (path == null) {
          path = self.$current_path()
        }
        path_parts = self.$get_path_parts(path);
        canonical_parts = self.$get_path_parts(self.$canonical_path_for_path(path));
        return ($a = ($b = canonical_parts.$each_with_index()).$reduce, $a.$$p = (TMP_7 = function(params, $c){var self = TMP_7.$$s || this, $a, param = nil;
if (params == null) params = nil;var part = $c[0], index = $c[1];
        if ((($a = part['$start_with?'](":")) !== nil && (!$a.$$is_boolean || $a == true))) {
            param = part['$[]']($range(1, -1, false));
            params['$[]='](param, path_parts['$[]'](index));};
          return params;}, TMP_7.$$s = self, TMP_7), $a).call($b, $hash2([], {}));
      });
      ...
      Opal.defn(self, '$nested_routes', function() {
        var self = this;

        return self.routes;
      });

      Opal.defn(self, '$current_path', function() {
        var self = this;

        return self.$location().$path();
      });

      Opal.defs(self, '$current_path', function() {
        var self = this;

        return self.$location().$path();
      });

      Opal.defn(self, '$current_url', function() {
        var self = this;

        return self.$location().$href();
      });

      Opal.defs(self, '$current_url', function() {
        var self = this;

        return self.$location().$href();
      });

      Opal.defs(self, '$location', function() {
        var self = this;

        return $scope.get('Bowser').$window().$location();
      });

      Opal.defn(self, '$navigate_to', function(path) {
        var self = this;

        self.$history().$push(path);
        self.$set_outlets();
        return self.$render_application();
      });

      Opal.defs(self, '$navigate_to', function(path) {
        var self = this;

        $scope.get('Bowser').$window().$history().$push(path);
        return self.$render_all_apps();
      });

      Opal.defn(self, '$navigate_to_remote', function(path) {
        var $a, $b, self = this;

        return (($a = [path]), $b = self.$location(), $b['$href='].apply($b, $a), $a[$a.length-1]);
      });

      Opal.defn(self, '$back', function() {
        var self = this;

        return self.$history().$back();
      });

      Opal.defn(self, '$set_outlets', function(targets) {
        var $a, $b, TMP_8, $c, $d, self = this;

        if (targets == null) {
          targets = self.$targets_for_path(self.$current_path())
        }
        if ((($a = targets['$any?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ($a = ($b = (targets.$count())).$times, $a.$$p = (TMP_8 = function(index){var self = TMP_8.$$s || this, $a, $b;
if (index == null) index = nil;
          return (($a = [targets['$[]']($rb_plus(index, 1))]), $b = targets['$[]'](index), $b['$outlet='].apply($b, $a), $a[$a.length-1])}, TMP_8.$$s = self, TMP_8), $a).call($b);
          return ($a = self.$application(), $a !== false && $a !== nil ?(($c = [targets.$first()]), $d = self.$application().$component(), $d['$outlet='].apply($d, $c), $c[$c.length-1]) : $a);
          } else {
          return ($a = self.$application(), $a !== false && $a !== nil ?(($c = [nil]), $d = self.$application().$component(), $d['$outlet='].apply($d, $c), $c[$c.length-1]) : $a)
        };
      });

      self.$private();

      Opal.defn(self, '$get_path_parts', function(path) {
        var $a, $b, self = this;

        return ($a = ($b = path.$split("/")).$reject, $a.$$p = "empty?".$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$render_application', function() {
        var $a, $b, self = this;

        if ((($a = ($b = self.$application(), $b !== false && $b !== nil ?self.$application().$component() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$application().$component().$call()
          } else {
          return nil
        };
      });

      return (Opal.defs(self, '$render_all_apps', function() {
        var self = this;

        return (($scope.get('Clearwater')).$$scope.get('Application')).$render();
      }), nil) && 'render_all_apps';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/application_registry"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$new', '$<<', '$each', '$render_current_url', '$to_proc', '$delete']);
  self.$require("set");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base, $super) {
      ...
      var self = $ApplicationRegistry = $klass($base, $super, 'ApplicationRegistry', $ApplicationRegistry);
      ...
      Opal.defn(self, '$initialize', function() {
        ...
        return self.apps = $scope.get('Set').$new();
      });

      Opal.defn(self, '$<<', function(app) {
        var self = this;

        return self.apps['$<<'](app);
      });

      Opal.defn(self, '$render_all', TMP_1 = function() {
        var $a, $b, TMP_2, self = this, $iter = TMP_1.$$p, block = $iter || nil;

        TMP_1.$$p = null;
        return ($a = ($b = self.apps).$each, $a.$$p = (TMP_2 = function(app){var self = TMP_2.$$s || this, $a, $b;
if (app == null) app = nil;
        return ($a = ($b = app).$render_current_url, $a.$$p = block.$to_proc(), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($b);
      });

      return (Opal.defn(self, '$delete', function(app) {
        var self = this;

        return self.apps.$delete(app);
      }), nil) && 'delete';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater/application"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$new', '$attr_reader', '$render_all', '$fetch', '$document', '$window', '$application=', '$router', '$component', '$router=', '$warn', '$+', '$on', '$render', '$<<', '$render_current_url', '$to_proc', '$watch_url', '$set_outlets', '$on_render', '$animation_frame', '$perform_render', '$body', '$debug?', '$puts', '$round', '$-', '$!', '$nil?', '$element', '$raise', '$benchmark', '$sanitize_content', '$virtual_dom', '$run_callbacks', '$each', '$clear']);
  self.$require("bowser");
  self.$require("clearwater/router");
  self.$require("clearwater/application_registry");
  self.$require("native");
  return (function($base) {
    var $Clearwater, self = $Clearwater = $module($base, 'Clearwater');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_7, TMP_9, TMP_10, TMP_12;

      def.component = def.document = def.watching_url = def.window = def.will_render = def.element = def.debug = def.virtual_dom = nil;
      Opal.cdecl($scope, 'AppRegistry', $scope.get('ApplicationRegistry').$new());

      self.$attr_reader("router", "component", "api_client", "on_render");

      Opal.defs(self, '$render', function() {
        var self = this;

        return $scope.get('AppRegistry').$render_all();
      });
      ...
      Opal.defn(self, '$initialize', function(options) {
        ...
        self.router = ($a = ($b = options).$fetch, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

        return $scope.get('Router').$new()}, TMP_1.$$s = self, TMP_1), $a).call($b, "router");
        self.component = ($a = ($c = options).$fetch, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

        return nil}, TMP_2.$$s = self, TMP_2), $a).call($c, "component");
        self.element = ($a = ($d = options).$fetch, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return nil}, TMP_3.$$s = self, TMP_3), $a).call($d, "element");
        self.document = ($a = ($e = options).$fetch, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

        return $scope.get('Bowser').$document()}, TMP_4.$$s = self, TMP_4), $a).call($e, "document");
        self.window = ($a = ($f = options).$fetch, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

        return $scope.get('Bowser').$window()}, TMP_5.$$s = self, TMP_5), $a).call($f, "window");
        self.on_render = [];
        (($a = [self]), $g = self.$router(), $g['$application='].apply($g, $a), $a[$a.length-1]);
        if ((($a = self.$component()) !== nil && (!$a.$$is_boolean || $a == true))) {
          (($a = [self.$router()]), $g = self.$component(), $g['$router='].apply($g, $a), $a[$a.length-1])};
        if ((($a = self.component.type === 'Thunk' && typeof self.component.render === 'function') !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$warn($rb_plus($rb_plus("Application root component (" + (self.component) + ") points to a cached ", "component. Cached components must not be persistent components, "), "such as application roots or routing targets."))};
        return ($a = ($g = self.document).$on, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $a;
          if (self.render_on_visibility_change == null) self.render_on_visibility_change = nil;

        if ((($a = self.render_on_visibility_change) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.render_on_visibility_change = false;
            return self.$render();
            } else {
            return nil
          }}, TMP_6.$$s = self, TMP_6), $a).call($g, "visibilitychange");
      });

      Opal.defn(self, '$call', TMP_7 = function() {
        var $a, $b, self = this, $iter = TMP_7.$$p, block = $iter || nil;

        TMP_7.$$p = null;
        $scope.get('AppRegistry')['$<<'](self);
        ($a = ($b = self).$render_current_url, $a.$$p = block.$to_proc(), $a).call($b);
        return self.$watch_url();
      });

      Opal.defn(self, '$watch_url', function() {
        var $a, $b, TMP_8, self = this;

        if ((($a = self.watching_url) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          ($a = ($b = self.window).$on, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

          return self.$render_current_url()}, TMP_8.$$s = self, TMP_8), $a).call($b, "popstate");
          return self.watching_url = true;
        };
      });

      Opal.defn(self, '$render_current_url', TMP_9 = function() {
        var $a, $b, self = this, $iter = TMP_9.$$p, block = $iter || nil;

        TMP_9.$$p = null;
        self.$router().$set_outlets();
        return ($a = ($b = self).$render, $a.$$p = block.$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$render', TMP_10 = function() {
        var $a, $b, TMP_11, self = this, $iter = TMP_10.$$p, block = $iter || nil;

        TMP_10.$$p = null;
        if (block !== false && block !== nil) {
          self.$on_render()['$<<'](block)};
        if ((($a = self.will_render) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        self.will_render = true;
        if ((($a = !!self.document.hidden) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.render_on_visibility_change = true;
          return nil;};
        ($a = ($b = self.window).$animation_frame, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

        return self.$perform_render()}, TMP_11.$$s = self, TMP_11), $a).call($b);
        return nil;
      });
      ...
      Opal.defn(self, '$element', function() {
        ...
        return ((($a = self.element) !== false && $a !== nil) ? $a : self.element = (function() {if ((($b = self.document.$body()) !== nil && (!$b.$$is_boolean || $b == true))) {
      ...
      Opal.defn(self, '$benchmark', TMP_12 = function(message) {
        var $a, self = this, $iter = TMP_12.$$p, $yield = $iter || nil, start = nil, result = nil, finish = nil;
        ...
        if ((($a = self['$debug?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          self.$puts("" + (message) + " in " + (($rb_minus(finish, start)).$round(3)) + "ms");
          return result;
          } else {
          return $a = Opal.yieldX($yield, []), $a === $breaker ? $a : $a
        };
      ...
      Opal.defn(self, '$perform_render', function() {
        var $a, $b, TMP_13, $c, TMP_14, self = this, rendered = nil;

        if ((($a = self.$element()['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('TypeError'), "Cannot render to a non-existent element. Make sure the document ready event has been triggered before invoking the application.")};
        rendered = ($a = ($b = self).$benchmark, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

        return $scope.get('Component').$sanitize_content(self.$component().$render())}, TMP_13.$$s = self, TMP_13), $a).call($b, "Generated virtual DOM");
        ($a = ($c = self).$benchmark, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

        return self.$virtual_dom().$render(rendered)}, TMP_14.$$s = self, TMP_14), $a).call($c, "Rendered to actual DOM");
        self.will_render = false;
        self.$run_callbacks();
        return nil;
      });

      Opal.defn(self, '$virtual_dom', function() {
        var $a, self = this;

        return ((($a = self.virtual_dom) !== false && $a !== nil) ? $a : self.virtual_dom = (($scope.get('VirtualDOM')).$$scope.get('Document')).$new(self.$element()));
      });

      return (Opal.defn(self, '$run_callbacks', function() {
        var $a, $b, self = this;

        ($a = ($b = self.$on_render()).$each, $a.$$p = "call".$to_proc(), $a).call($b);
...
/* Generated by Opal 0.9.2 */
Opal.modules["clearwater"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
  ...
  Opal.add_stubs(['$require']);
  self.$require("clearwater/component");
  self.$require("clearwater/svg_component");
  self.$require("clearwater/cached_render");
  self.$require("clearwater/link");
  return self.$require("clearwater/application");
};

/* Generated by Opal 0.9.2 */
Opal.modules["grand_central/version"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  return (function($base) {
    var $GrandCentral, self = $GrandCentral = $module($base, 'GrandCentral');
...
/* Generated by Opal 0.9.2 */
Opal.modules["grand_central/store"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$attr_reader', '$state', '$call', '$run_callbacks', '$<<', '$each']);
  return (function($base) {
    var $GrandCentral, self = $GrandCentral = $module($base, 'GrandCentral');
    ...
    (function($base, $super) {
      ...
      def.reducer = def.dispatch_callbacks = nil;
      self.$attr_reader("state");

      Opal.defn(self, '$initialize', TMP_1 = function(initial_state) {
        var self = this, $iter = TMP_1.$$p, reducer = $iter || nil;

        TMP_1.$$p = null;
        self.state = initial_state;
        self.reducer = reducer;
        return self.dispatch_callbacks = [];
      });

      Opal.defn(self, '$dispatch', function(action) {
        var self = this, old_state = nil;

        old_state = self.$state();
        self.state = self.reducer.$call(self.$state(), action);
        self.$run_callbacks(old_state, self.$state(), action);
        return action;
      });

      Opal.defn(self, '$on_dispatch', TMP_2 = function() {
        var self = this, $iter = TMP_2.$$p, block = $iter || nil;

        TMP_2.$$p = null;
        self.dispatch_callbacks['$<<'](block);
        return self;
      });

      return (Opal.defn(self, '$run_callbacks', function(old_state, new_state, action) {
        var $a, $b, TMP_3, self = this;

        if (action == null) {
          action = nil
        }
        return ($a = ($b = self.dispatch_callbacks).$each, $a.$$p = (TMP_3 = function(callback){var self = TMP_3.$$s || this;
if (callback == null) callback = nil;
        return callback.$call(old_state, new_state, action)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      }), nil) && 'run_callbacks';
    })($scope.base, null)
  })($scope.base)
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["grand_central/action"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$new', '$send', '$each_with_index', '$instance_variable_set', '$[]', '$class_exec', '$to_proc', '$with_attributes', '$then', '$promise', '$fail', '$always', '$block']);
  return (function($base) {
    var $GrandCentral, self = $GrandCentral = $module($base, 'GrandCentral');
    ...
    (function($base, $super) {
      ...
      Opal.defs(self, '$with_attributes', TMP_1 = function() {
        var $a, $b, TMP_2, $c, $d, self = this, $iter = TMP_1.$$p, body = $iter || nil, klass = nil, $splat_index = nil;

        var array_size = arguments.length - 0;
        if(array_size < 0) array_size = 0;
        var attributes = new Array(array_size);
        for($splat_index = 0; $splat_index < array_size; $splat_index++) {
          attributes[$splat_index] = arguments[$splat_index + 0];
        }
        TMP_1.$$p = null;
        klass = $scope.get('Class').$new(self);
        ($a = ($b = klass).$send, $a.$$p = (TMP_2 = function(args){var self = TMP_2.$$s || this, $a, $b, TMP_3;
args = $slice.call(arguments, 0);
        return ($a = ($b = attributes).$each_with_index, $a.$$p = (TMP_3 = function(attribute, index){var self = TMP_3.$$s || this;
if (attribute == null) attribute = nil;if (index == null) index = nil;
          return self.$instance_variable_set("@" + (attribute), args['$[]'](index))}, TMP_3.$$s = self, TMP_3), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($b, "define_method", "initialize");
        ($a = klass).$send.apply($a, ["attr_reader"].concat(Opal.to_a(attributes)));
        if ((body !== nil)) {
          ($c = ($d = klass).$class_exec, $c.$$p = body.$to_proc(), $c).call($d)};
        return klass;
      });

      Opal.defs(self, '$create', TMP_4 = function() {
        var $a, $b, self = this, $iter = TMP_4.$$p, block = $iter || nil;

        TMP_4.$$p = null;
        return ($a = ($b = self).$with_attributes, $a.$$p = block.$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$then', TMP_5 = function() {
        var $a, $b, self = this, $iter = TMP_5.$$p, block = $iter || nil;

        TMP_5.$$p = null;
        return ($a = ($b = self.$promise()).$then, $a.$$p = block.$to_proc(), $a).call($b);
      });
      ...
      Opal.defn(self, '$fail', TMP_6 = function() {
        ...
        TMP_6.$$p = null;
        return ($a = ($b = self.$promise()).$fail, $a.$$p = block.$to_proc(), $a).call($b);
      });

      return (Opal.defn(self, '$always', function() {
        var $a, $b, self = this;

        return ($a = ($b = self.$promise()).$always, $a.$$p = self.$block().$to_proc(), $a).call($b);
      }), nil) && 'always';
    })($scope.base, null)
  })($scope.base)
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["grand_central"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var $a, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$require', '$!=']);
  self.$require("grand_central/version");
  self.$require("grand_central/store");
  self.$require("grand_central/action");
  (function($base) {
    var $GrandCentral, self = $GrandCentral = $module($base, 'GrandCentral');
...
/* Generated by Opal 0.9.2 */
Opal.modules["components/todo_item"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$include', '$attr_reader', '$!', '$equal?', '$todo', '$==', '$editing?', '$div', '$input', '$name', '$method', '$completed?', '$label', '$button', '$dispatch', '$new', '$code', '$===', '$value', '$target', '$done_editing!']);
  return (function($base, $super) {
    function $TodoItem(){};
    var self = $TodoItem = $klass($base, $super, 'TodoItem', $TodoItem);
    ...
    self.$include((($scope.get('Clearwater')).$$scope.get('CachedRender')));

    self.$attr_reader("todo");

    Opal.defn(self, '$initialize', function(todo, editing) {
      var self = this;
    ...
    Opal.defn(self, '$should_render?', function(previous) {
      var $a, self = this;

      return (($a = self.$todo()['$equal?'](previous.$todo()), $a !== false && $a !== nil ?self['$editing?']()['$=='](previous['$editing?']()) : $a))['$!']();
    });

    Opal.defn(self, '$render', function() {
      var $a, self = this;

      return self.$div([(function() {if ((($a = self['$editing?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return self.$input($hash2(["class_name", "default_value", "onkeydown", "autofocus"], {"class_name": "edit", "default_value": self.$todo().$name(), "onkeydown": self.$method("handle_edit_key_down"), "autofocus": true}))
        } else {
        return self.$div($hash2(["class_name"], {"class_name": "view"}), [self.$input($hash2(["class_name", "type", "checked", "onchange"], {"class_name": "toggle", "type": "checkbox", "checked": self.$todo()['$completed?'](), "onchange": self.$method("toggle_todo")})), self.$label($hash2(["ondblclick"], {"ondblclick": self.$method("edit_todo")}), self.$todo().$name()), self.$button($hash2(["class_name", "onclick"], {"class_name": "destroy", "onclick": self.$method("delete_todo")}))])
      }; return nil; })()]);
    });

    Opal.defn(self, '$toggle_todo', function() {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('ToggleTodo')).$new(self.$todo()));
    });

    Opal.defn(self, '$edit_todo', function() {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('EditTodo')).$new(self.$todo()));
    });

    Opal.defn(self, '$editing?', function() {
      var self = this;

      return self.editing;
    });

    Opal.defn(self, '$done_editing!', function() {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('DoneEditingTodo')).$new(self.$todo()));
    });

    Opal.defn(self, '$delete_todo', function() {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('DeleteTodo')).$new(self.$todo()));
    });

    return (Opal.defn(self, '$handle_edit_key_down', function(event) {
      var self = this, $case = nil;

      return (function() {$case = event.$code();if ((13)['$===']($case)) {$scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('RenameTodo')).$new(self.$todo(), event.$target().$value()));
      return self['$done_editing!']();}else if ((27)['$===']($case)) {return self['$done_editing!']()}else { return nil }})();
    }), nil) && 'handle_edit_key_down';
  })($scope.base, null)
};

/* Generated by Opal 0.9.2 */
Opal.modules["components/todo_list"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$include', '$attr_reader', '$!', '$equal?', '$todos', '$editing_todos', '$section', '$input', '$method', '$all?', '$completed?', '$ul', '$todo_items', '$dispatch', '$new', '$checked?', '$target', '$map', '$include?', '$li', '$id', '$todo_class', '$join', '$compact']);
  self.$require("components/todo_item");
  return (function($base, $super) {
    function $TodoList(){};
    var self = $TodoList = $klass($base, $super, 'TodoList', $TodoList);
    ...
    self.$attr_reader("todos", "editing_todos");

    Opal.defn(self, '$initialize', function(todos, editing_todos) {
      var self = this;

      self.todos = todos;
      return self.editing_todos = editing_todos;
    });

    Opal.defn(self, '$should_render?', function(previous) {
      var $a, self = this;

      return (($a = self.$todos()['$equal?'](previous.$todos()), $a !== false && $a !== nil ?self.$editing_todos()['$equal?'](previous.$editing_todos()) : $a))['$!']();
    });

    Opal.defn(self, '$render', function() {
      var $a, $b, TMP_1, self = this;

      return self.$section($hash2(["id"], {"id": "main"}), [self.$input($hash2(["id", "type", "onchange", "checked"], {"id": "toggle-all", "type": "checkbox", "onchange": self.$method("toggle_all"), "checked": ($a = ($b = self.$todos())['$all?'], $a.$$p = (TMP_1 = function(t){var self = TMP_1.$$s || this;
if (t == null) t = nil;
      return t['$completed?']()}, TMP_1.$$s = self, TMP_1), $a).call($b)})), self.$ul($hash2(["id"], {"id": "todo-list"}), self.$todo_items())]);
    });

    Opal.defn(self, '$toggle_all', function(event) {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('ToggleAllTodos')).$new(event.$target()['$checked?']()));
    });

    Opal.defn(self, '$todo_items', function() {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = self.$todos()).$map, $a.$$p = (TMP_2 = function(todo){var self = TMP_2.$$s || this, editing = nil;
if (todo == null) todo = nil;
      editing = self.$editing_todos()['$include?'](todo);
        return self.$li($hash2(["key", "class_name"], {"key": todo.$id(), "class_name": self.$todo_class(todo['$completed?'](), editing)}), [$scope.get('TodoItem').$new(todo, editing)]);}, TMP_2.$$s = self, TMP_2), $a).call($b);
    });

    return (Opal.defn(self, '$todo_class', function(completed, editing) {
      var self = this;

      return [((function() {if (completed !== false && completed !== nil) {
        return "completed"
        } else {
        return nil
      }; return nil; })()), ((function() {if (editing !== false && editing !== nil) {
        return "editing"
        } else {
        return nil
...
/* Generated by Opal 0.9.2 */
Opal.modules["components/layout"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$include', '$div', '$header', '$h1', '$input', '$method', '$outlet', '$todo_list', '$footer', '$new', '$[]', '$state', '$dispatch', '$code', '$===', '$add_todo', '$value', '$target', '$clear', '$count', '$to_proc', '$tag', '$span', '$strong', '$==', '$ul', '$li', '$clear_button', '$button']);
  self.$require("components/todo_list");
  return (function($base, $super) {
    function $Layout(){};
    ...
    Opal.defn(self, '$render', function() {
      ...
      return self.$div(nil, [self.$header($hash2(["id"], {"id": "header"}), [self.$h1(nil, "todos"), self.$input($hash2(["id", "placeholder", "onkeydown", "autofocus"], {"id": "new-todo", "placeholder": "What needs to be done?", "onkeydown": self.$method("handle_new_todo_key_down"), "autofocus": true}))]), (((($a = self.$outlet()) !== false && $a !== nil) ? $a : self.$todo_list())), self.$footer()]);
    });

    Opal.defn(self, '$todo_list', function() {
      var self = this;

      return $scope.get('TodoList').$new($scope.get('Store').$state()['$[]']("todos"), $scope.get('Store').$state()['$[]']("editing_todos"));
    });

    Opal.defn(self, '$add_todo', function(name) {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('AddTodo')).$new($scope.get('Todo').$new(name)));
    });

    Opal.defn(self, '$handle_new_todo_key_down', function(event) {
      var self = this, $case = nil;

      return (function() {$case = event.$code();if ((13)['$===']($case)) {self.$add_todo(event.$target().$value());
      return event.$target().$clear();}else if ((27)['$===']($case)) {return event.$target().$clear()}else { return nil }})();
    });

    Opal.defn(self, '$footer', function() {
      var $a, $b, self = this, active_count = nil;

      active_count = ($a = ($b = $scope.get('Store').$state()['$[]']("todos")).$count, $a.$$p = "active?".$to_proc(), $a).call($b);
      return self.$tag("footer#footer", nil, [self.$span($hash2(["id"], {"id": "todo-count"}), [self.$strong(nil, active_count), " todo" + ((function() {if (active_count['$=='](1)) {
        return nil
        } else {
        return "s"
      }; return nil; })()) + " left"]), self.$ul($hash2(["id"], {"id": "filters"}), [self.$li($scope.get('Link').$new($hash2(["href"], {"href": "/"}), "All")), self.$li($scope.get('Link').$new($hash2(["href"], {"href": "/active"}), "Active")), self.$li($scope.get('Link').$new($hash2(["href"], {"href": "/completed"}), "Completed"))]), self.$clear_button()]);
    });

    Opal.defn(self, '$clear_button', function() {
      var self = this;

      return self.$button($hash2(["id", "onclick"], {"id": "clear-completed", "onclick": self.$method("clear_completed")}), "Clear completed");
    });

    return (Opal.defn(self, '$clear_completed', function() {
      var self = this;

      return $scope.get('Store').$dispatch((($scope.get('Actions')).$$scope.get('ClearCompletedTodos')).$new());
    }), nil) && 'clear_completed';
  })($scope.base, null);
};

/* Generated by Opal 0.9.2 */
Opal.modules["components/active_todo_list"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$select', '$to_proc']);
  self.$require("components/todo_list");
  return (function($base, $super) {
    function $ActiveTodoList(){};
    var self = $ActiveTodoList = $klass($base, $super, 'ActiveTodoList', $ActiveTodoList);

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    return (Opal.defn(self, '$todos', TMP_1 = function() {
      var $a, $b, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil;
      ...
      return ($a = ($b = Opal.find_super_dispatcher(self, 'todos', TMP_1, $iter).apply(self, $zuper)).$select, $a.$$p = "active?".$to_proc(), $a).call($b);
    }), nil) && 'todos'
  })($scope.base, $scope.get('TodoList'));
};

/* Generated by Opal 0.9.2 */
Opal.modules["components/completed_todo_list"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;
  ...
  return (function($base, $super) {
    ...
    var self = $CompletedTodoList = $klass($base, $super, 'CompletedTodoList', $CompletedTodoList);
    ...
    return (Opal.defn(self, '$todos', TMP_1 = function() {
      ...
      return ($a = ($b = Opal.find_super_dispatcher(self, 'todos', TMP_1, $iter).apply(self, $zuper)).$select, $a.$$p = "completed?".$to_proc(), $a).call($b);
    }), nil) && 'todos'
  })($scope.base, $scope.get('TodoList'));
};

/* Generated by Opal 0.9.2 */
Opal.modules["components/todo_list_wrapper"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var $a, $b, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$new', '$include', '$component_class', '$[]', '$state']);
  return Opal.cdecl($scope, 'TodoListWrapper', ($a = ($b = $scope.get('Struct')).$new, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

  self.$include((($scope.get('Clearwater')).$$scope.get('Component')));
    return (Opal.def(self, '$render', function() {
      var self = this;

      return self.$component_class().$new($scope.get('Store').$state()['$[]']("todos"), $scope.get('Store').$state()['$[]']("editing_todos"));
    }), nil) && 'render';}, TMP_1.$$s = self, TMP_1), $a).call($b, "component_class"))
};

/* Generated by Opal 0.9.2 */
Opal.modules["models/todo"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$attr_reader', '$rand', '$!', '$completed?', '$new', '$class', '$fetch', '$name', '$instance_exec', '$id', '$update']);
  return (function($base, $super) {
    function $Todo(){};
    ...
    def.completed = nil;
    self.$attr_reader("id", "name");

    Opal.defn(self, '$initialize', function(name, $kwargs) {
      var self = this, completed = nil;
      ...
      if ((completed = $kwargs.$$smap['completed']) == null) {
        completed = false
      }
      self.id = self.$rand();
      self.name = name;
    ...
    Opal.defn(self, '$completed?', function() {
      var self = this;

      return self.completed['$!']()['$!']();
    });

    Opal.defn(self, '$active?', function() {
      var self = this;

      return self['$completed?']()['$!']();
    });

    Opal.defn(self, '$update', function(attributes) {
      var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, self = this, updated = nil;

      if (attributes == null) {
        attributes = $hash2([], {})
      }
      updated = self.$class().$new(($a = ($b = attributes).$fetch, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$name()}, TMP_1.$$s = self, TMP_1), $a).call($b, "name"), $hash2(["completed"], {"completed": ($a = ($c = attributes).$fetch, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return self['$completed?']()}, TMP_2.$$s = self, TMP_2), $a).call($c, "completed")}));
      ($a = ($d = updated).$instance_exec, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

      return self.id = self.$id()}, TMP_3.$$s = self, TMP_3), $a).call($d);
      return updated;
    });

    Opal.defn(self, '$toggled', function(completed) {
      var self = this;

      if (completed == null) {
        completed = self['$completed?']()['$!']()
      }
      return self.$update($hash2(["completed"], {"completed": completed}));
    });

    return (Opal.defn(self, '$toggle!', function(value) {
      var self = this;
...
/* Generated by Opal 0.9.2 */
Opal.modules["serializers/todos"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$attr_reader', '$to_json', '$map', '$id', '$name', '$completed?', '$todos', '$parse', '$allocate', '$each', '$instance_variable_set', '$new']);
  self.$require("models/todo");
  self.$require("json");
  return (function($base, $super) {
    function $TodosSerializer(){};
    var self = $TodosSerializer = $klass($base, $super, 'TodosSerializer', $TodosSerializer);

    var def = self.$$proto, $scope = self.$$scope;

    self.$attr_reader("todos");

    Opal.defn(self, '$initialize', function(todos) {
      var self = this;
    ...
    Opal.defn(self, '$to_json', function() {
      ...
      return ($a = ($b = self.$todos()).$map, $a.$$p = (TMP_1 = function(todo){var self = TMP_1.$$s || this;
if (todo == null) todo = nil;
      return $hash2(["id", "name", "completed"], {"id": todo.$id(), "name": todo.$name(), "completed": todo['$completed?']()})}, TMP_1.$$s = self, TMP_1), $a).call($b).$to_json();
    });

    return (Opal.defs(self, '$from_json', function(json) {
      var $a, $b, TMP_2, self = this, hashes = nil, todos = nil;

      hashes = $scope.get('JSON').$parse(json);
      todos = ($a = ($b = hashes).$map, $a.$$p = (TMP_2 = function(hash){var self = TMP_2.$$s || this, $a, $b, TMP_3, todo = nil;
if (hash == null) hash = nil;
      todo = $scope.get('Todo').$allocate();
        ($a = ($b = hash).$each, $a.$$p = (TMP_3 = function(attr, value){var self = TMP_3.$$s || this;
if (attr == null) attr = nil;if (value == null) value = nil;
        return todo.$instance_variable_set("@" + (attr), value)}, TMP_3.$$s = self, TMP_3), $a).call($b);
        return todo;}, TMP_2.$$s = self, TMP_2), $a).call($b);
      return self.$new(todos);
    }), nil) && 'from_json';
  })($scope.base, null);
};

/* Generated by Opal 0.9.2 */
Opal.modules["repositories/todo"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$include', '$attr_reader', '$load_from_storage', '$todos', '$from_json', '$to_json', '$new', '$each', '$to_proc', '$reject!', '$save!', '$<<', '$delete']);
  self.$require("serializers/todos");
  return (function($base, $super) {
    function $TodoRepository(){};
    var self = $TodoRepository = $klass($base, $super, 'TodoRepository', $TodoRepository);
    ...
    Opal.defn(self, '$load!', function() {
      ...
      return self.todos = self.$load_from_storage();
    });

    Opal.defn(self, '$load_from_storage', function() {
      var self = this;

      return $scope.get('TodosSerializer').$from_json(localStorage.todos || '[]').$todos();
    });

    Opal.defn(self, '$save!', function() {
      var self = this;

      return  localStorage.todos = $scope.get('TodosSerializer').$new(self.$todos()).$to_json() ;
    });
    ...
    Opal.defn(self, '$each', TMP_1 = function() {
      ...
      TMP_1.$$p = null;
      return ($a = ($b = self.$todos()).$each, $a.$$p = block.$to_proc(), $a).call($b);
    });

    Opal.defn(self, '$reject!', TMP_2 = function() {
      var $a, $b, self = this, $iter = TMP_2.$$p, block = $iter || nil;

      TMP_2.$$p = null;
      ($a = ($b = self.$todos())['$reject!'], $a.$$p = block.$to_proc(), $a).call($b);
      return self['$save!']();
    });

    Opal.defn(self, '$<<', function(todo) {
      var self = this;
    ...
    return (Opal.defn(self, '$delete', function(todo) {
      var self = this;
...
/* Generated by Opal 0.9.2 */
Opal.modules["actions"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$require', '$include', '$with_attributes', '$new']);
  self.$require("grand_central");
  return (function($base) {
    var $Actions, self = $Actions = $module($base, 'Actions');

    var def = self.$$proto, $scope = self.$$scope;

    self.$include($scope.get('GrandCentral'));

    Opal.cdecl($scope, 'AddTodo', $scope.get('Action').$with_attributes("todo"));

    Opal.cdecl($scope, 'ToggleTodo', $scope.get('Action').$with_attributes("todo"));

    Opal.cdecl($scope, 'DeleteTodo', $scope.get('Action').$with_attributes("todo"));

    Opal.cdecl($scope, 'EditTodo', $scope.get('Action').$with_attributes("todo"));

    Opal.cdecl($scope, 'RenameTodo', $scope.get('Action').$with_attributes("todo", "name"));

    Opal.cdecl($scope, 'DoneEditingTodo', $scope.get('Action').$with_attributes("todo"));

    Opal.cdecl($scope, 'ClearCompletedTodos', $scope.get('Class').$new($scope.get('Action')));

    Opal.cdecl($scope, 'ToggleAllTodos', $scope.get('Action').$with_attributes("completed"));
  })($scope.base);
};
...
Opal.modules["store"] = function(Opal) {
  ...
  var $a, $b, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, initial_state = nil;

  Opal.add_stubs(['$load!', '$new', '$===', '$merge', '$+', '$[]', '$todo', '$map', '$==', '$toggled', '$-', '$update', '$name', '$completed', '$reject', '$to_proc']);
  initial_state = $hash2(["todos", "editing_todos"], {"todos": $scope.get('TodoRepository').$new()['$load!'](), "editing_todos": $scope.get('Set').$new()});
  return Opal.cdecl($scope, 'Store', ($a = ($b = (($scope.get('GrandCentral')).$$scope.get('Store'))).$new, $a.$$p = (TMP_1 = function(state, action){var self = TMP_1.$$s || this, $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, $e, $case = nil;
if (state == null) state = nil;if (action == null) action = nil;
  return (function() {$case = action;if ((($scope.get('Actions')).$$scope.get('AddTodo'))['$===']($case)) {return state.$merge($hash2(["todos"], {"todos": $rb_plus(state['$[]']("todos"), [action.$todo()])}))}else if ((($scope.get('Actions')).$$scope.get('ToggleTodo'))['$===']($case)) {return state.$merge($hash2(["todos"], {"todos": ($a = ($b = state['$[]']("todos")).$map, $a.$$p = (TMP_2 = function(todo){var self = TMP_2.$$s || this;
if (todo == null) todo = nil;
    if (todo['$=='](action.$todo())) {
        return todo.$toggled()
        } else {
        return todo
      }}, TMP_2.$$s = self, TMP_2), $a).call($b)}))}else if ((($scope.get('Actions')).$$scope.get('DeleteTodo'))['$===']($case)) {return state.$merge($hash2(["todos"], {"todos": $rb_minus(state['$[]']("todos"), [action.$todo()])}))}else if ((($scope.get('Actions')).$$scope.get('RenameTodo'))['$===']($case)) {return state.$merge($hash2(["todos"], {"todos": ($a = ($c = state['$[]']("todos")).$map, $a.$$p = (TMP_3 = function(todo){var self = TMP_3.$$s || this;
if (todo == null) todo = nil;
    if (todo['$=='](action.$todo())) {
        return todo.$update($hash2(["name"], {"name": action.$name()}))
        } else {
        return todo
      }}, TMP_3.$$s = self, TMP_3), $a).call($c)}))}else if ((($scope.get('Actions')).$$scope.get('EditTodo'))['$===']($case)) {return state.$merge($hash2(["editing_todos"], {"editing_todos": $rb_plus(state['$[]']("editing_todos"), [action.$todo()])}))}else if ((($scope.get('Actions')).$$scope.get('DoneEditingTodo'))['$===']($case)) {return state.$merge($hash2(["editing_todos"], {"editing_todos": $rb_minus(state['$[]']("editing_todos"), [action.$todo()])}))}else if ((($scope.get('Actions')).$$scope.get('ToggleAllTodos'))['$===']($case)) {return state.$merge($hash2(["todos"], {"todos": ($a = ($d = state['$[]']("todos")).$map, $a.$$p = (TMP_4 = function(todo){var self = TMP_4.$$s || this;
if (todo == null) todo = nil;
    return todo.$toggled(action.$completed())}, TMP_4.$$s = self, TMP_4), $a).call($d)}))}else if ((($scope.get('Actions')).$$scope.get('ClearCompletedTodos'))['$===']($case)) {return state.$merge($hash2(["todos"], {"todos": ($a = ($e = state['$[]']("todos")).$reject, $a.$$p = "completed?".$to_proc(), $a).call($e)}))}else {return state}})()}, TMP_1.$$s = self, TMP_1), $a).call($b, initial_state));
};
...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var $a, $b, TMP_1, $c, TMP_2, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, router = nil;

  Opal.add_stubs(['$require', '$new', '$route', '$[]', '$document', '$on_dispatch', '$equal?', '$save!', '$state', '$render', '$call']);
  self.$require("opal");
  self.$require("clearwater");
  self.$require("grand_central");
  self.$require("set");
  self.$require("components/layout");
  self.$require("components/active_todo_list");
  self.$require("components/completed_todo_list");
  self.$require("components/todo_list_wrapper");
  self.$require("repositories/todo");
  self.$require("actions");
  self.$require("store");
  router = ($a = ($b = (($scope.get('Clearwater')).$$scope.get('Router'))).$new, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

  self.$route($hash2(["active"], {"active": $scope.get('TodoListWrapper').$new($scope.get('ActiveTodoList'))}));
    return self.$route($hash2(["completed"], {"completed": $scope.get('TodoListWrapper').$new($scope.get('CompletedTodoList'))}));}, TMP_1.$$s = self, TMP_1), $a).call($b);
  Opal.cdecl($scope, 'App', (($scope.get('Clearwater')).$$scope.get('Application')).$new($hash2(["component", "router", "element"], {"component": $scope.get('Layout').$new(), "router": router, "element": $scope.get('Bowser').$document()['$[]']("#todoapp")})));
  ($a = ($c = $scope.get('Store')).$on_dispatch, $a.$$p = (TMP_2 = function(old, new$){var self = TMP_2.$$s || this, $a;
if (old == null) old = nil;if (new$ == null) new$ = nil;
  if ((($a = old['$equal?'](new$)) !== nil && (!$a.$$is_boolean || $a == true))) {
      return nil
      } else {
      $scope.get('TodoRepository').$new($scope.get('Store').$state()['$[]']("todos"))['$save!']();
      return $scope.get('App').$render();
    }}, TMP_2.$$s = self, TMP_2), $a).call($c);
  return $scope.get('App').$call();
})(Opal);
